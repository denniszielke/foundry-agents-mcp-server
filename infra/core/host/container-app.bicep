...
module foundryAccess '../security/foundry-access.bicep' = {
  name: '${deployment().name}-foundry-access'
  params: {
...
resource app 'Microsoft.App/containerApps@2023-04-01-preview' = {
  ...
  // This also forces us to use an user assigned managed identity since there would be no way to
